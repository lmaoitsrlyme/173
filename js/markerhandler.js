...
AFRAME.registerComponent("markerhandler", {
  ...
  askUserId: function() {
    ...
    swal({
      title: "oMG HEY BESTIEE",
      icon: iconUrl,
      content: {
        element: "input",
        attributes: {
          placeholder: "say hi back now."
        }
      }
    }).then(inputValue => {
      uid = inputValue;
  ...
  handleMarkerFound: function(toys, markerId) {
    ...
    if (toy.is_out_of_stock) {
      swal({
        ...
        text: "hAhAh no more uwu come back later or never",
        timer: 2500,
        buttons: false
      });
    } else {
      ...
      orderButtton.addEventListener("click", () => {
        ...
        swal({
          ...
          title: "thanks for the money bestie",
          text: "  ",
          timer: 2000,
          buttons: false
        });
    ...
    firebase
      ...
      .then(() => {
        swal({
          icon: "success",
          title: "m",
          text: "if it's broken too bad uwu",
          timer: 2500,
          buttons: false
        });
      });
